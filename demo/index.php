...
<body class="p-0 m-0">
                            ...
                            <ul class="pt-2 h4 font-weight-bold">
                                ...
                                <li class="m-0 m-md-2 mt-md-5 ml-md-5 pt-3"><i class="icon-wrench m-md-2 mt-2"></i>How to link the dependencies to your website:
                                    <ul class="p-0 p-md-3 font-weight-normal mt-2 ml-md-5">
                                        <li class="m-md-2 pt-2"><i class="icon-lock h6 text-success m-2"></i>3th party libraries can be linked in the header together with all css! Include the redman-photoGallery.css as last added css!</li>
                                        ...
                                        <li class=" m-0 m-md-2 pt-2"><i class="icon-lock h6 text-danger m-2"></i>EXCEPTION: redman-photoGallery.js needs to be inserted at the end of your webpage!</li>
            ...
            <!-- first excample gallery-->
                <div class="col-12 order-2 order-md-1 col-md-6 pr-3 pt-5 pt-md-0">
                    ...
                    <div class="redman-gallery" data-redman-totalCount="17" data-redman-countPerPage="6" data-redman-countPerRow="3" data-redman-startHeight="250" data-redman-theme="dark">
                        ...
                        <img src="img/test7.jpg" alt="wrong path">
    ...
    <!--2nd excample-->
    <div class="container-fluid bg-light text-dark pt-5 pb-5">
        <div class="container">
            ...
            <div class='row no-gutters m-auto'>
                ...
                <div class="col-12 col-md-6 font-weight-bold border-bottom border-dark">
                    ...
                    <div class="col-12 col-md-6 mt-5">
                        <div class="redman-gallery" data-redman-totalCount="9" data-redman-countPerPage="10" data-redman-countPerRow="3" data-redman-startHeight="250" data-redman-theme="light">
                            ...
                            <img src="img/test27.jpg" alt="fout">
                        </div>
                    </div>
                </div>
            </div>
