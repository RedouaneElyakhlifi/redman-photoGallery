...
<body class="p-0 m-0">
    ...
    <div class="container-fluid bg-light text-dark p-0">
        <div id="masthead" class="m-0 p-0 text-custom text-orange">
            <div id="overlay" class="pt-5 pb-5">
                            ...
                            <ul class="pt-2 h4 font-weight-bold">
                                ...
                                <li class="m-0 m-md-2 mt-md-5 ml-md-5 pt-3"><i class="icon-wrench m-md-2 mt-2"></i>How to link the dependencies to your website:
                                    <ul class="p-0 p-md-3 font-weight-normal mt-2 ml-md-5">
                                        ...
                                        <li class="mt-4"><i class="icon-lock-open h6 text-success m-md-2"></i><strong>COPY/PASTE URL's:</strong></li><br>
                                        ...
                                        &#x3c;link rel="stylesheet" href="css/<br class="d-md-none">redman-photoGallery<br class="d-md-none">.min.css"></li><br>
                                        ...
                                        &#x3c;script src="js/<br class="d-md-none">redman-photoGallery<br class="d-md-none">.min.js">&#x3c;/script></li><br>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="col-12 font-weight-bold">
                    ...
                    <ul class="mt-5 m-0 ml-md-3 h3 font-weight-bold pt-2">
                        <li class="pt-2"><i class="icon-wrench"></i>Settings (attributes):
                            <ul class="pt-2 h4 font-weight-bold">
                                <li class="m-0 m-md-2 pt-3"><i class="icon-lock text-danger m-md-2"></i>class="<span class="text-danger">redman<span class="d-inline-block d-md-none">&nbsp</span>-gallery</span>" -->this cannot change!! Use this class to adress the plugin.</li>
                                ...
                                <li class="m-0 m-md-2 mt-md-5 ml-md-5 pt-3"><i class="icon-wrench m-md-2 mt-2"></i>code excample(this is just an excample, you can use your own variables depending on your needs!): 
                                    <ul class="p-0 p-md-3 font-weight-normal mt-2 ml-md-5">
                                        ...
                                        <li class='mt-2 bg-lightgrey '>&#x3c;div class="redman-gallery" data-redman-totalCount="" data-redman-countPerPage="" data-redman-countPerRow="" data-redman-startHeight="" data-redman-theme="" data-redman-screenwidth=""&#x3e; &#x3c;/div&#x3e;</li><br>
        ...
        <div class="container bg-dark text-white">
            ...
            <!-- first excample gallery-->
                <div class="col-12 order-2 order-md-1 col-md-6 pr-3 pt-5 pt-md-0">
                    ...
                    <div class="redman-gallery" data-redman-totalCount="17" data-redman-countPerPage="6" data-redman-countPerRow="3" data-redman-startHeight="200" data-redman-theme="dark" data-redman-screenwidth="1920">
...
<iframe width="735" height="600" src="https://www.youtube.com/embed/DEQJp3fCzy0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" ></iframe>
</div>
</div>
</section>
<footer>
<div id="masthead" class="m-0 p-0 text-custom text-orange">
            <div id="overlay" class="p-0 m-0">
